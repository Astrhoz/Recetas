<x-guest-layout>
    ...
    <section id="about" class="flex flex-col items-center justify-center bg-secondary text-center text-primary py-20">
        ...
        <img
            ...
            alt="Recetero"
            class="h-[50vw] max-h-[400px] mt-[-4vw] object-cover"
        />
        <div class="text-lg font-thin px-8 mt-12">
            <strong>Recetero</strong> es una red social donde puedes encontrar recetas de cualquier tipo realizadas por otros usuarios. Principalmente queremos que encuentres recetas según los ingredientes que tengas disponible en tu hogar. Además, buscamos que puedas interactuar con nuestra web, de formas similares a como lo harías en otras páginas.
        </div>
    </section>
    ...
    <section class="bg-primary py-12 px-6">
        <div id="explore" class="max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
            ...
            <div class="space-y-4">
                <div class="inline-block bg-secondary text-primary px-3 py-1 rounded-md text-sm font-semibold">Receta Destacada</div>
                ...
                <a href="#explore" class="inline-flex items-center gap-2 bg-secondary text-primary px-4 py-2 rounded-md hover:bg-secondary-900">
                    Ver receta
                </a>
            </div>
        </div>
        ...
        <div class="max-w-5xl mx-auto mt-10">
            ...
            <div class="text-secondary-900">
                <input
                    type="text"
                    placeholder="Ingresa lo que quieres encontrar..."
        ...
        <div id="categories" class="max-w-5xl mx-auto mt-10">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                <a href="#categories" class="bg-secondary rounded-lg p-4 flex flex-col items-center gap-2 hover:bg-secondary-900">
                    <span class="text-primary font-medium">Ensaladas</span>
                </a>
                <a href="#categories" class="bg-secondary rounded-lg p-4 flex flex-col items-center gap-2 hover:bg-secondary-900">
                ...
                <a href="#categories" class="bg-secondary rounded-lg p-4 flex flex-col items-center gap-2 hover:bg-secondary-900">
                    <span class="text-primary font-medium">Hamburguesas</span>
                </a>
            </div>
        </div>
        ...
        <div id="cards" class="max-w-5xl mx-auto mt-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                <x-post.post-card img="https://image.lexica.art/full_webp/0c164d71-4aa3-4625-bba0-a1b40c60c3be"
                    ...
                    paragraph="Elevate your dinner with this delicious baked salmon recipe, topped with a tangy lemon dill sauce." />
                <x-post.post-card img="https://image.lexica.art/full_webp/0c164d71-4aa3-4625-bba0-a1b40c60c3be"
                    title="Baked Salmon with Lemon Dill Sauce"
                    paragraph="Elevate your dinner with this delicious baked salmon recipe, topped with a tangy lemon dill sauce." />
                <x-post.post-card img="https://image.lexica.art/full_webp/0c164d71-4aa3-4625-bba0-a1b40c60c3be"
